...
<tr>
	...
	<td>
	<input name="Level" type="text" value="<%=MyPerson.ReturnLevelName(p.getCode())%>"></td><td><div id="StudentNameMsg"></div></td>
</tr>
<tr>
	<td> Department: <font color="red">*</font></td>
	<td>
	<input name="Department:" type="text" value="<%=MyPerson.ReturnDepartmentName(p.getCode())%>"></td><td><div id="StudentNameMsg"></div></td>
</tr>
<tr>
